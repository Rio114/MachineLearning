...
//texequation{
TPR = \frac{TP数}{TP+FPの数} = \frac{3}{4} = 0.75
//}
...
//texequation{
TPR = \frac{TP数}{TP+FPの数} = \frac{4}{6} = 0.75
//}
...
また、見込みのない人への間違った訴求は10%に抑えたいので、本当にサービス加入してくれるであろう顧客の40%の見逃すのも止む無し、という議論であればROC曲線で見る。

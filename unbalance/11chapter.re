...
Accuracy@<sub>{A} = (90 + 9,900) / 10,100 = 0.9891
Accuracy@<sub>{B} = (99 + 9,000) / 10,100 = 0.9009
//}
...
Precision@<sub>{A} = 90 / (90 + 100) = 0.4738
Precision@<sub>{B} = 99 / (99 + 1,000) = 0.0901
//}
...
F1@<sub>{A} = 2 x 0.4737 x 0.9000 / (0.4737 + 0.9000) = 0.6406
F1@<sub>{B} = 2 x 0.0901 x 0.9900 / (0.0901 + 0.9900) = 0.1638
//}

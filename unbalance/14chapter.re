...
集団alphaをよくよく見てみるとクリックしやすい人としにくい人がいるような仮説が浮かんだとする。
...
@<table>{predicted_ctr}は登録者ごとに補正済みのCTR予測値を広告ごとに算出したものとする。集団alphaやbetaの中での区別をするために、便宜的に1，2，3、、、というように分けている。例えば、alpha@<sub>{1}はalphaの中の>>1さんである。
